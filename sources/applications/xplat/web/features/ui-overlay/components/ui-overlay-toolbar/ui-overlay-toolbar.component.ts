...
import { UiOverlayToolbarBaseComponent } from '@application/features';
...
export class UiOverlayToolbarComponent extends UiOverlayToolbarBaseComponent implements OnInit {
