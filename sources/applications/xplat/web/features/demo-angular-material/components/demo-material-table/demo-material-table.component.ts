...
import { DemoMaterialTableBaseComponent } from '@application/features';
...
export class DemoMaterialTableComponent extends DemoMaterialTableBaseComponent implements OnInit {
