module.exports = {
  ...
  metafiles: [
    ...
    'apps/web-application/tsconfig.app.json',
    'apps/web-application/tsconfig.browser.json',
    'apps/web-application/tsconfig.server.json',
    'apps/web-application/src/index.html',
    'apps/web-application/src/main.server.ts',
    'tsconfg.json'
  ],
  logger: console,
  ...
  onDown(container) {
    this.logger.info('>> container down', {
      pid: container.proc.pid
    });
  },
