...
define('fonts/helveticaneue-medium', [], function() {
  return function(codeList) {
    ...
    hnm['B'] = {
      ...
      holeCmds: [
        [
          [[422, 325], [201, 325], [201, 102], [422, 102], [542, 102, 542, 215], [542, 325, 422, 325]],
          [
            [405, 612],
            [201, 612],
            [201, 415],
    ...
    hnm['V'] = {
      shapeCmds: [
        [[372, 0], [233, 0], [-5, 714], [125, 714], [304, 149], [306, 149], [489, 714], [616, 714], [372, 0]]
      ],
      xMin: -5,
      xMax: 616,
      yMin: 0,
    ...
    hnm['$'] = {
      ...
      holeCmds: [
        [
          [[302, 306], [302, 73], [425, 82, 425, 192], [425, 243, 387, 271], [360, 291, 302, 306]],
    ...
    hnm['!'] = {
      ...
      shapeCmds: [
        [[110, 199], [77, 508], [77, 714], [202, 714], [202, 508], [169, 199], [110, 199]],
...
define('fonts/jura-medium', [], function() {
  return function(codeList) {
    ...
    jur['B'] = {
      ...
      holeCmds: [
        [
          [[354, 312], [475, 312, 516, 302, 516, 200], [516, 184], [516, 83, 475, 72, 336, 72], [156, 72], [156, 312]],
          [
            [306, 384],
            [156, 384],
            [156, 559],
...
define('index', [
  ...
  var Wrapper = function() {
    ...
    function MeshWriter(lttrs, opt) {
      ...
      offsetX =
        anchor === 'right' ? 0 - meshesAndBoxes.xWidth : anchor === 'center' ? 0 - meshesAndBoxes.xWidth / 2 : 0;
  ...
  function constructLetterPolygons(
    ...
    function buildLetterMeshes(letter, index, spec, reverseShapes, reverseHoles) {
      ...
      function getCmd(list, ix) {
        ...
        len = cmd.length;
        thisX =
          len === 3 || len === 5 || len === 7 ? round(cmd[len - 2] * xFactor + thisX) : round(cmd[len - 2] * xFactor);
        thisZ =
          len === 3 || len === 5 || len === 7 ? round(cmd[len - 1] * zFactor + thisZ) : round(cmd[len - 1] * zFactor);
