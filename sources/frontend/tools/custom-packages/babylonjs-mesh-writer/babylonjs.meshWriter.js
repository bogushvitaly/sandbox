...
module.exports = function () {
  return function (codeList) {
    ...
    hpb["B"] = {
      ...
      hC: [
        ["CÃFP CÃC8 CÃC*D.C* EyC* FcC*F¼Cn GPD0GPD¥ GPETF¼E» FcF]EyF] D,F] CÃFZCÃFP", "CÃK% CÃH> CÃH0D,H0 E6H0 E¹H2FGHq FyI.FyIw FyJ>FFJ{ E·K6E0K6 D.K6 CÃK6CÃK%"]
      ],
      xMin: 58,
      xMax: 508,
      yMin: 0,
    ...
    hpb["8"] = {
      ...
      hC: [
        ["GJFC F¥F¯E½F¯ E2F¯DiFC CÁE{CÁDµ CÁD*DiCa E2B¹E½B¹ F¡B¹GHCa GµD*GµDµ GµE{GJFC", "F¹Jµ FcKFE½KF ERKFDÀJ´ DiJ]DiI¹ DiILD¿Hº EPHcE½Hc FcHcF¹H» GJINGJI¹ GJJ_F¹Jµ"]
      ],
      xMin: 59,
      xMax: 540,
      yMin: -8,
...
module.exports = function () {
  return function (codeList) {
    ...
    csn["B"] = {
      ...
      hC: [
        ["E­K¼ DÀK¼DrKµ DpJd D[Ga EjGTEtGU F­GbGkH3 HQH¯HQI» HQJxGiKH F¢K¼E­K¼", "F{Ey E³E¬ E¦E¬EiEª ENE©E@E© D­E©DME² DGD´DGD. DGB` FMBiGsC) H8CDHyC~ I5D1I5DK I5D{H5E5 GUEcF{Ey"]
      ],
      xMin: 95,
      xMax: 604,
      yMin: -24,
    ...
    csn["T"] = {
      ...
      shapeCmds: [
        [
          ...
          [342.5, 53.5, 345, 68.5],
          [347.5, 83.5, 347.5, 91],
          [347.5, 115.5, 344, 164.5],
          [341, 213.5, 341, 238.5],
          [341, 310, 329.5, 439.5],
          [317.5, 579.5, 316, 640.5],
          [270.5, 640],
          [161, 640, 98.5, 656],
          [58, 666.5, 58, 705.5],
          [58, 726, 71, 741.5],
          [86, 759, 109.5, 757.5],
          [127, 756.5, 189.5, 748.5],
          [239.5, 742.5, 270.5, 742.5],
          [300.5, 742.5, 361.5, 743.5],
          [422.5, 745, 452.5, 745],
          [491, 745, 566.5, 739.5],
          [642.5, 734, 681, 734],
          [702.5, 734, 717, 719],
          [731.5, 704.5, 731.5, 682.5],
          [731.5, 661, 717, 646],
          [702.5, 631.5, 681, 631.5]
        ]
      ],
      xMin: 58,
      xMax: 731,
    ...
    csn["Z"] = {
      shapeCmds: [
        [
          ...
          [562.5, -18, 548, -18],
          [472, -18, 319.5, -22],
          [167.5, -25.5, 91.5, -25.5],
          [34, -25.5, 34, 25],
          [34, 58, 65, 108],
          [118.5, 182.5],
          [299, 433.5],
          [410.5, 581, 506.5, 662.5],
          [331.5, 652.5],
          [129.5, 652.5],
          [124, 652.5, 113, 651.5],
          [102.5, 651, 97.5, 651],
          [44.5, 651, 44.5, 702.5],
          [44.5, 736.5, 71.5, 747.5],
          [88, 754.5, 126, 754.5],
          [160.5, 754.5, 228.5, 747],
          [297, 740, 331.5, 740],
          [370, 740, 446.5, 745],
          [523.5, 750, 562.5, 750],
          [691, 750, 691, 701.5],
      ...
      holeCmds: [
        [
          [
            ...
            [165.5, 193.5],
            [166, 111.5],
            [190, 100.5, 233.5, 83.5],
            [264.5, 74, 303, 74],
            [375.5, 74, 422, 125],
            [468.5, 176, 468.5, 252],
            [468.5, 326.5, 431, 376.5],
            [390.5, 430.5, 322, 430.5]
          ]
        ]
      ],
      xMin: 76,
    ...
    csn["d"] = {
      ...
      shapeCmds: [
        [
          ...
          [51.5, 360.5, 122, 441],
          [193, 521.5, 306, 521.5],
          [364, 521.5, 395.5, 503.5],
          [442.5, 469],
          [449.5, 679.5, 459, 752.5],
          [465.5, 797, 504.5, 797],
          [550, 797, 550, 748.5],
          [550, 679, 530, 441.5]
        ]
    ...
    csn["e"] = {
      ...
      hC: [
        ['E¨H" D®H"D:GD CjFgCAE( EuF: G)FµGwGS FÃH"E¨H"']
      ],
      xMin: 43,
      xMax: 541,
      yMin: -23,
    ...
    csn["f"] = {
      ...
      shapeCmds: [
        [
          ...
          [157, -53.5, 157, -33.5],
          [157, -29.5, 158, -23.5],
          [168.5, 41.5, 168.5, 118],
          [167, 254.5],
          [167, 399.5],
          [104.5, 394.5, 88, 394.5],
          [37.5, 394.5, 37.5, 443],
          [37.5, 492.5, 125, 495],
          [173, 496.5],
          [174.5, 524.5, 180.5, 572.5],
          [193.5, 683.5, 236.5, 736],
          [288.5, 799.5, 399, 799.5],
          [470.5, 799.5, 470.5, 751],
          [470.5, 703, 405.5, 703]
        ]
      ],
      xMin: 38,
    ...
    csn["g"] = {
      ...
      holeCmds: [
        [
          [
            [320.5, 432],
            [225.5, 432, 173.5, 366.5],
            [127, 307.5, 127, 216.5],
            [127, 144, 154.5, 107.5],
            [182, 71, 237, 71],
            [287.5, 71, 335, 128],
            [378, 180.5, 384, 232],
            [394.5, 286, 406.5, 401.5],
            [386.5, 417, 365, 424.5],
            [343.5, 432, 320.5, 432]
          ]
        ]
    ...
    csn["h"] = {
      ...
      shapeCmds: [
        [
          ...
          [452.5, -31, 441.5, 7],
          [430, 48, 420.5, 123.5],
          [411.5, 196, 411.5, 242.5],
          [411.5, 255.5, 412.5, 282],
          [414, 308.5, 414, 321.5],
          [414, 415.5, 367, 415.5],
          [303.5, 415.5, 253.5, 358],
          [228, 328.5, 183.5, 245.5],
          [183.5, 55, 167.5, 20],
          [153.5, -11, 124, -11],
          [103.5, -11, 88, 3],
          [72.5, 17, 72.5, 37],
          ...
          [108.5, 801, 129.5, 801],
          [170.5, 801, 177.5, 757],
          [185.5, 708.5, 185.5, 669.5],
          [185.5, 617, 182, 560],
          [179, 505.5, 179.5, 450.5],
          [180, 406.5],
          [221, 461.5, 267.5, 488.5],
          [314.5, 516, 367, 516],
          [450, 516, 481, 462],
          [503, 424, 506, 334],
          [510, 238.5],
...
module.exports = function () {
  ...
  var scene,
    ...
    wgd,
    debug;
  var b128back = new Uint8Array(256),
  ...
  var Wrapper = function () {
    ...
    function MeshWriter(lttrs, opt) {
      ...
      this.color = function (c) {
        return NES(c) ? color = c : color;
      };

      this.alpha = function (o) {
        return Amp(o) ? opac = o : opac;
      };
      ...
      function setPositn(field, tst, defalt) {
  ...
  function rgb2Bcolor3(rgb) {
    ...
    function convert(x) {
      return Γ(1000 * Math.max(0, Math.min((tyN(parseInt(x, 16)) ? parseInt(x, 16) : 0) / 255, 1))) / 1000;
    }
  }
  ...
  function makeLetterSpec(fontSpec, letter) {
    ...
    function decode6(s) {
      return [decode1(s.substring(0, 2)), decode1(s.substring(2, 4)), decode1(s.substring(4, 6)), decode1(s.substring(6, 8)), decode1(s.substring(8, 10)), decode1(s.substring(10, 12))];
    }

    ;

    function decode4(s) {
      return [decode1(s.substring(0, 2)), decode1(s.substring(2, 4)), decode1(s.substring(4, 6)), decode1(s.substring(6, 8))];
    }
  ...
  function codeList(list, _str, _xtra) {
    ...
    if (tyA(list)) {
      list.forEach(function (cmds) {
        if (cmds.length === 6) {
          _str += _xtra + code6(cmds);
          _xtra = " ";
        }

        if (cmds.length === 4) {
          _str += _xtra + code4(cmds);
          _xtra = " ";
        }

        if (cmds.length === 2) {
          _str += _xtra + code2(cmds);
          _xtra = " ";
        }
      });
    }
  ...
  function NEA(ma) {
    return ma != null && typeof ma === "object" && ma.constructor === Array && 0 < ma.length;
  }
