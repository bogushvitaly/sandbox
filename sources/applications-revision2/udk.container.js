module.exports = {
  ...
  metafiles: [
    ...
    "apps/portal-web/tsconfig.server.json",
    "apps/portal-web/src/index.html",
    "apps/portal-web/src/main.server.ts",
    "tsconfg.json"
  ],
  logger: console,
  ...
  onBundleAvailable(bundle) {
    this.logger.info(
      `>>> [${bundle.compiler.name}] bundleAvailable ${bundle.mainOutputPath}`
    );
  },
