...
import { Hero } from "@applications/features";
...
export class HeroService {
  ...
  getHeroes(): Observable<Hero[]> {
    return of(this.state.get(HeroService.getHeroesStateKey, [])).pipe(
      switchMap(heroes => {
  ...
  getHeroNo404<Data>(id: number): Observable<Hero> {
    return of(this.state.get(HeroService.getHeroStateKey, {})).pipe(
      ...
      tap(hero => {
        this.state.set(HeroService.getHeroStateKey, {
  ...
  searchHeroes(term: string): Observable<Hero[]> {
    ...
    return of(this.state.get(HeroService.searchHeroesStateKey, {})).pipe(
      ...
      tap(heroes => {
        this.state.set(HeroService.searchHeroesStateKey, {
  ...
  addHero(hero: Hero): Observable<Hero> {
    return this.http
      .post<Hero>(this.heroesUrl, hero, HeroService.httpOptions)
      .pipe(
        tap((createdHero: Hero) =>
          this.log(`added hero w/ id=${createdHero.id}`)
        ),
