...
import { DemoOpencvFaceDetectionBaseComponent } from "@applications/features";

declare var cv: any;

@Component({
  selector: "app-demo-opencv-face-detection",
  templateUrl: "demo-opencv-face-detection.component.html",
  styleUrls: ["demo-opencv-face-detection.component.scss"]
})
export class DemoOpencvFaceDetectionComponent
  extends DemoOpencvFaceDetectionBaseComponent
  implements AfterViewInit, OnInit {
  imageUrl = "assets/opencv-test.jpg";
    ...
    this.ngOpenCVService.isReady$
      .pipe(
        ...
        tap((result: OpenCVLoadResult) => {
          this.ngOpenCVService
            .loadImageToHTMLCanvas(
              this.imageUrl,
