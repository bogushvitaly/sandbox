    ...
    hpb["="] = {
      ...
      shapeCmds: [
        [
          [107, 306 - 60],
          [465, 306 - 60],
          [514, 306 - 60, 514, 261 - 60],
          [514, 255 - 60, 513, 253 - 60],
          [514, 250 - 60, 514, 245 - 60],
          [514, 200 - 60, 465, 200 - 60],
          [107, 200 - 60],
          [58, 200 - 60, 58, 245 - 60],
          [58, 253 - 60],
          [58, 261 - 60],
          [58, 306 - 60, 107, 306 - 60]
        ],
        [
          [107, 306 + 130],
          [465, 306 + 130],
          [514, 306 + 130, 514, 261 + 130],
          [514, 255 + 130, 513, 253 + 130],
          [514, 250 + 130, 514, 245 + 130],
          [514, 200 + 130, 465, 200 + 130],
          [107, 200 + 130],
          [58, 200 + 130, 58, 245 + 130],
          [58, 253 + 130],
          [58, 261 + 130],
          [58, 306 + 130, 107, 306 + 130]
        ]
      ],
      xMin: 58,
      xMax: 514,
    ...
    hnm["$"] = {
      ...
      holeCmds: [
        [
          ...
          [[259, 441], [259, 641], [146, 641, 146, 543], [146, 469, 259, 441]]
        ]
      ],
      xMin: 16,
      xMax: 539,
...
*/
    ...
    function tildeRaw(dx, dy) {
      return [
        [297 + dx, 714 + dy],
        [279 + dx, 599 + dy, 186 + dx, 599 + dy],
        [163 + dx, 599 + dy, 113.5 + dx, 617.5 + dy],
        [64 + dx, 636 + dy, 43 + dx, 636 + dy],
        [26 + dx, 636 + dy, 13.5 + dx, 623 + dy],
        [1 + dx, 610 + dy, 1 + dx, 595 + dy],
        [-56 + dx, 595 + dy],
        [-49 + dx, 639 + dy, -24 + dx, 671 + dy],
        [6 + dx, 708 + dy, 48 + dx, 708 + dy],
        [81 + dx, 708 + dy, 127.5 + dx, 689 + dy],
        [174 + dx, 670 + dy, 191 + dx, 670 + dy],
...
define("index", [
  ...
  "./fonts/jura-medium",
  "./fonts/webgl-dings"
], function(HPB, HNM, CSN, JUR, WGD) { // Otherwise it assigns it to global variable 'BABYLONTYPE' // If BABYLON is loaded, it assigns the superconstructor to BABYLON.MeshWriter // This function loads the specific type-faces and returns the superconstructor // *-*=*  *=*-* *-*=*  *=*-* *-*=*  *=*-* *-*=*  *=*-* *-*=*  *=*-* *-*=*  *=*-*
  var scene,
    FONTS,
    defaultColor,
    defaultOpac,
  ...
  var Wrapper = function() {
    ...
    function MeshWriter(lttrs, opt) {
      ...
      offsetX =
        anchor === "right"
          ? 0 - meshesAndBoxes.xWidth
          : anchor === "center"
          ? 0 - meshesAndBoxes.xWidth / 2
          : 0;
  ...
  function constructLetterPolygons(
    ...
    function buildLetterMeshes(
      ...
      combo = [
        shapeCmdsLists.map(makeMeshFromCmdsList(reverseShape)),
      ...
      function makeMeshFromCmdsList(reverse) {
        return function meshFromCmdsList(cmdsList) {
          var cmd = getCmd(cmdsList, 0),
            path = new BABYLON.Path2(adjXfix(cmd[0]), adjZfix(cmd[1])),
            array,
            meshBuilder,
            mesh,
            j;
          ...
          meshBuilder = new BABYLON.PolygonMeshBuilder(
      ...
      function makeAdjust(letterScale, factor, off, shift, relative, xAxis) {
        if (relative) {
          if (xAxis) {
            return function(val) {
              return round(letterScale * (val * factor + shift + lastX + off));
            };
          } else {
            return function(val) {
              return round(letterScale * (val * factor + shift + lastZ + off));
            };
          }
        } else {
          return function(val) {
            return round(letterScale * (val * factor + shift + off));
          };
        }
      }
    }
  ...
  function makeMaterial(
    ...
    var cm0 = new BABYLON.StandardMaterial(
  ...
  function supplementCurveFunctions() {
    ...
    BABYLON.Path2.prototype.addQuadraticCurveTo = function(
      redX,
      redY,
      blueX,
      blueY
      ...
      var curve = BABYLON.Curve3.CreateQuadraticBezier(
        origin,
        control,
        destination,
        nb_of_points
    ...
    BABYLON.Path2.prototype.addCubicCurveTo = function(
      redX,
      redY,
      greenX,
      greenY,
      ...
      var curve = BABYLON.Curve3.CreateCubicBezier(
        origin,
        control1,
        control2,
        destination,
  ...
  function makeLetterSpec(fontSpec, letter) {
      ...
      if (!isArray(letterSpec.holeCmds) && isArray(letterSpec.hC)) {
        letterSpec.holeCmds = letterSpec.hC.map(function(cmdslists) {
          if (isArray(cmdslists)) {
            return cmdslists.map(function(cmds) {
              return decodeList(cmds);
            });
          } else {
            return cmdslists;
    ...
    function decode6(s) {
      return [
        ...
        decode1(s.substring(2, 4)),
        decode1(s.substring(4, 6)),
        decode1(s.substring(6, 8)),
        decode1(s.substring(8, 10)),
  ...
  function merge(arrayOfMeshes) {
    return arrayOfMeshes.length === 1
      ? arrayOfMeshes[0]
      : BABYLON.Mesh.MergeMeshes(arrayOfMeshes, true);
  }
